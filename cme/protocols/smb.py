...
class smb(connection):
    ...
    def proto_args(parser, std_parser, module_parser):
        ...
        smb_parser.add_argument("-uH", '--user-hash', metavar="USERHASH", dest='userhash', nargs='+', default=[], help='File(s) containing User and NTLM hashes to test. Secretdump format.')
